...
function CardComponent() {
    return (
        <Card className="max-w-sm " imgSrc="https://api.istad.co/media/image/899bac49-e47c-406c-abb2-30ad0b498f88.png" horizontal>
            <h5 className="text-2xl font-simebold tracking-tight text-gray-900 dark:text-white">
                Flutter Mobile Development
            </h5>
            <span className="bg-red-400 p-1 w-36 rounded-lg text-white ">20% Scholarship</span>
