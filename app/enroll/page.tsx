...
export default function Enroll() {
    return (
        <section className=" bg-[#f5f5f5] w-full py-10">
            <div className=" w-[80%] bg-white mx-auto rounded-lg py-5 ">
                    ...
                    <div>
                        <form className="grid grid-cols-1 gap-4">
                            <div>
                                ...
                                <TextInput id="fullname1" type="email" placeholder="Long Piseth" required />
                            </div>
                            <div>
                                <div className="mb-2 block ">
                            ...
                            <div>
                                ...
                                <Select id="course" required>
                                    ...
                                    <option value="10">Kratié</option>
                                    <option value="11">Mondulkiri</option>
                                    <option value="12">Oddar Meanchey</option>
                                    <option value="13">Pailin</option>
                                    <option value="14">Preah Sihanouk (Sihanoukville)</option>
                                    <option value="15">Preah Vihear</option>
                                    <option value="16">Pursat</option>
                                    <option value="17">Prey Veng</option>
                                    <option value="18">Ratanakiri</option>
                                    <option value="19">Siem Reap</option>
                                    <option value="20">Stung Treng</option>
                                    <option value="21">Svay Rieng</option>
                                    <option value="22">Takeo</option>
                                    <option value="23">Tbong Khmum</option>
                                    <option value="24">Kep (also known as Kep Province)</option>
                                    <option value="25">Otdar Meanchey</option>
                                </Select>
                    ...
                    <div>
                        <form className="grid grid-cols-1 gap-4">
                            ...
                            <div>
                                ...
                                <TextInput id="username3" placeholder="0123456789 (Telegram)" addon="+855" required />
                            </div>
                            <div>
                                <div className="mb-2 block ">
                ...
                {/*Button*/}
                <div className="flex justify-end gap-4 mr-[60px] ">
                    <button
